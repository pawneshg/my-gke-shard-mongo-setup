...
do
    # 4GB disks    
    gcloud compute disks create --size 4GB --type pd-ssd --zone europe-west1-b pd-ssd-disk-4g-$i
done
for i in 1 2 3 4 5 6 7 8 9
do
    # 8 GB disks
    gcloud compute disks create --size 8GB --type pd-ssd  --zone europe-west1-b pd-ssd-disk-8g-$i
done
sleep 3
